    ...
    var AudioPlayer = (function() {
        ...
        function renderPL() {
            ...
            pl = create('div', {
                ...
                'id': 'pl',
                'innerHTML': '<ul class="pl-ul">' + (!isEmptyList() ? html.join('') : '<li class="pl-list--empty">Su playlist está vacia :(</li>') + '</ul>'
            });
        ...
        function clearAll() {
            audio.pause();
            audio.src = '';
            trackTitle.innerHTML = 'Lista vacia';
            curTime.innerHTML = '--';
            durTime.innerHTML = '--';
            progressBar.style.width = 0;
            preloadBar.style.width = 0;
            ...
            playSvgPath.setAttribute('d', playSvg.getAttribute('data-play'));
            if (!plUl.querySelector('.pl-list--empty')) {
                plUl.innerHTML = '<li class="pl-list--empty">Su playlist está vacia :(</li>';
            }
            changeDocumentTitle();
        }
